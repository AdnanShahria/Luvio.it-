  ...
  return (
    <footer style={{
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 'var(--space-12)' }}>
          {/* Brand */}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              {['Jobs & Services', 'Marketplace', 'Explore', 'Premium'].map((link) => (
                <Link key={link} href="#" style={{ fontSize: '0.95rem', color: 'var(--text-secondary)', transition: 'all 0.2s ease', display: 'inline-block' }} 
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              ...
              >
                <div style={{ width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)' }}>
