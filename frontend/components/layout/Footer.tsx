...
export function Footer() {
  ...
  return (
    <footer style={{
      ...
      {/* Subtle top glow */}
      <div suppressHydrationWarning style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', width: '60%', height: '1px', background: 'linear-gradient(90deg, transparent, var(--color-primary-300), transparent)', opacity: 0.5 }} />
      
      <div suppressHydrationWarning className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div suppressHydrationWarning className="footer-grid">
          {/* Brand */}
          <div suppressHydrationWarning className="footer-brand-col">
            <div suppressHydrationWarning className="header-logo" style={{ marginBottom: 'var(--space-4)' }}>
          ...
          <div suppressHydrationWarning className="footer-nav-row">
            {/* Platform */}
            <div suppressHydrationWarning className="footer-nav-col">
              ...
              <div suppressHydrationWarning style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                {[
          ...
          {/* Download */}
          <div suppressHydrationWarning className="footer-app-col">
            <h4 style={{ fontWeight: 700, fontSize: '0.85rem', marginBottom: 'var(--space-6)', textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-primary)' }}>
              Get the App
            </h4>
            <div suppressHydrationWarning className="footer-app-buttons">
              <div suppressHydrationWarning style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: '#f8f9ff', borderRadius: '12px', border: '1px solid rgba(84, 101, 255, 0.1)', cursor: 'pointer', transition: 'all 0.2s ease' }}
              ...
              >
                <div suppressHydrationWarning style={{ width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)', flexShrink: 0 }}>
                ...
                <div suppressHydrationWarning>
                  <div suppressHydrationWarning style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', fontWeight: 600, textTransform: 'uppercase' }}>Coming Soon</div>
                  <div suppressHydrationWarning style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--color-primary-600)' }}>iOS App Store</div>
                </div>
              </div>
              <div suppressHydrationWarning style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: '#f8f9ff', borderRadius: '12px', border: '1px solid rgba(84, 101, 255, 0.1)', cursor: 'pointer', transition: 'all 0.2s ease' }}
                   onMouseOver={(e) => { e.currentTarget.style.borderColor = 'var(--color-primary-300)'; e.currentTarget.style.transform = 'translateY(-2px)' }}
              ...
              >
                ...
                <div suppressHydrationWarning>
                  <div suppressHydrationWarning style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', fontWeight: 600, textTransform: 'uppercase' }}>Coming Soon</div>
                  <div suppressHydrationWarning style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--color-primary-600)' }}>Google Play</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Bottom bar */}
        <div suppressHydrationWarning className="footer-bottom-bar">
